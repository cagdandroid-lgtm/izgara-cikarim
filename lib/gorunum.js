...
function kisisel(d, sid) {
  ...
  return {
    ...
    soruDeneme: o.soruDeneme || 0, tabloKullandi: !!o.tabloKullandi,
    dogruSayisi: o.dogruSayisi || 0, soruSayisi: o.soruSayisi || 0,
    isabet: o.ilkDenemeDogru || 0,
...
function ogretmenEk(d) {
  ...
  return {
    ...
    ilerlemeMod: d.ilerlemeMod, gecis: d.gecis, otomatikDoldur: d.otomatikDoldur,
    seviye: d.seviye,
    soru: d.soru ? { ...soruUreteci.acik(d.soru), dogruCevap: d.soru.secenekler[d.soru.dogru] } : null,
