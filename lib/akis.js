...
function cevapVer(durum, sid, atamalar) {
  ...
  if (gecen < EN_AZ_DUSUNME_MS) {
    return { hata: `Acele etme 🙂 ${Math.ceil((EN_AZ_DUSUNME_MS - gecen) / 1000)} sn sonra gönderebilirsin.` };
  }
  ...
  // (denetim 1) öğretmen geri atladıysa aynı bulmaca tekrar gelebilir: tekrarda puan YOK
