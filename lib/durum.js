...
class Durum {
  ...
  turSifirla() {
    ...
    this.soru = null;             // senkron modda herkesin cevapladığı ASIL SORU
  ...
  ayarla({ grup, seviye, mod, sureSn, dersEtiketi, ilerlemeMod, gecis, otomatikDoldur }) {
    ...
    if (ilerlemeMod === 'senkron' || ilerlemeMod === 'bireysel') this.ilerlemeMod = ilerlemeMod;
  ...
  /* Asıl soruya cevap: puanlama ve ilerleme burada. */
  cevap(sid, secim) { return akis.cevapVer(this, sid, secim); }
