...
app.use((req, res, next) => {
  // rapor.js de panel dosyasıdır (ölçme/karne arayüzü); öğrenci tarafında hiç yüklenmez
  if (/^\/(teacher\.(html|js)|rapor\.js)$/.test(req.path) && !yetkili(req)) return res.redirect('/teacher');
  next();
});
